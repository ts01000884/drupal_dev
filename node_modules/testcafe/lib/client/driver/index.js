	...
	"replicator": {
		...
		"index.js": function (exports, module, require) {
			...
			EncodingTransformer.prototype._applyTransform = function (val, parent, key, transform) {
			    ...
			    if ((typeof serializableVal === 'undefined' ? 'undefined' : _typeof(serializableVal)) === 'object') this._createCircularCandidate(val, parent, key);
			...
			DecodingTransformer.prototype._handleValue = function (val, parent, key) {
			    if ((typeof val === 'undefined' ? 'undefined' : _typeof(val)) !== 'object' || val === null) return;
				...
				"driver": {
					"command-executors": {
						...
						"client-functions": {
							...
							"selector-executor": {
								"filter.js": function (exports, module, require) {
									...
									// Selector filter
									_hammerhead2.default.nativeMethods.objectDefineProperty.call(window, window, '%testCafeSelectorFilter%', {
									    value: function value(node, options) {
									        var filtered = [];

									        if (node === null || node === void 0) filtered = [];else if (node instanceof Node) filtered = [node];else if (node instanceof HTMLCollection || node instanceof NodeList || isArrayOfNodes(node)) filtered = node;else throw new _testRun.InvalidSelectorResultError();

									        filtered = arrayUtils.filter(filtered, function (n) {
									            return (0, _elementUtils.exists)(n);
									        });

									        if (options.filterVisible) filtered = filtered.filter(function (n) {
									            return (0, _elementUtils.visible)(n);
									        });

									        if (options.filterHidden) filtered = filtered.filter(function (n) {
									            return !(0, _elementUtils.visible)(n);
									        });

									        if (options.counterMode) {
									            if (options.index !== null) return getNodeByIndex(filtered, options.index) ? 1 : 0;
									...
									var SelectorExecutor = function (_ClientFunctionExecut) {
									    ...
									    SelectorExecutor.prototype._validateElement = function _validateElement(args, startTime) {
									        ...
									        return _hammerhead.Promise.resolve().then(function () {
									            ...
									            if (createTimeoutError) throw createTimeoutError();
						...
						"execute-navigate-to.js": function (exports, module, require) {
							...
							var RequestBarrier = _testcafeCore2.default.RequestBarrier;
							var pageUnloadBarrier = _testcafeCore2.default.pageUnloadBarrier;
							...
							function executeNavigateTo(command) {
							    ...
							    return Promise.all([requestBarrier.wait(), pageUnloadBarrier.wait()]).then(function () {
					...
					"driver.js": function (exports, module, require) {
						...
						var Driver = function () {
						    ...
						    Driver.prototype._onJsError = function _onJsError(err) {
						        ...
						        var error = new _testRun.UncaughtErrorOnPage(err.msg || err.message, err.pageUrl);
						    ...
						    Driver.prototype._switchToIframe = function _switchToIframe(selector, iframeErrorCtors) {
						        ...
						        return (0, _executeSelector.getResult)(selector, commandSelectorTimeout, null, function () {
						            return new iframeErrorCtors.NotFoundError();
						        }, function () {
						    ...
						    Driver.prototype._onExecuteSelectorCommand = function _onExecuteSelectorCommand(command) {
						        ...
						        (0, _executeSelector.getResultDriverStatus)(command, this.selectorTimeout, startTime, null, null, this.statusBar).then(function (driverStatus) {
						...
						"ensure-elements.js": function (exports, module, require) {
							...
							function createElementDescriptor(selector) {
							    return {
							        ...
							        createNotFoundError: function createNotFoundError() {
							            return new _testRun.ActionElementNotFoundError();
							        },
							...
							function createAdditionalElementDescriptor(selector, elementName) {
							    return {
							        selector: selector,
							        createNotFoundError: function createNotFoundError() {
							            return new _testRun.ActionAdditionalElementNotFoundError(elementName);
							        },
							        createIsInvisibleError: function createIsInvisibleError() {
					...
					"index.js": function (exports, module, require) {
						...
						var ActionOptionsTypeError = exports.ActionOptionsTypeError = function (_TestRunErrorBase16) {
						    ...
						    function ActionOptionsTypeError(actualType) {
						        ...
						        var _this22 = _possibleConstructorReturn(this, _TestRunErrorBase16.call(this, _type2.default.actionOptionsTypeError));

						        _this22.actualType = actualType;
						        return _this22;
						    }
						...
						var ActionStringArrayElementError = exports.ActionStringArrayElementError = function (_ActionArgumentErrorB9) {
						    ...
						    function ActionStringArrayElementError(argumentName, actualValue, elementIndex) {
						        ...
						        var _this29 = _possibleConstructorReturn(this, _ActionArgumentErrorB9.call(this, _type2.default.actionStringArrayElementError, argumentName, actualValue));

						        _this29.elementIndex = elementIndex;
						        return _this29;
						    }
						...
						var ActionSelectorError = exports.ActionSelectorError = function (_TestRunErrorBase17) {
						    ...
						    function ActionSelectorError(selectorName, errMsg) {
						        ...
						        var _this32 = _possibleConstructorReturn(this, _TestRunErrorBase17.call(this, _type2.default.actionSelectorError));

						        _this32.selectorName = selectorName;
						        _this32.errMsg = errMsg;
						        return _this32;
						    }
						...
						var ActionSelectorMatchesWrongNodeTypeError = exports.ActionSelectorMatchesWrongNodeTypeError = function (_TestRunErrorBase20) {
						    ...
						    function ActionSelectorMatchesWrongNodeTypeError(nodeDescription) {
						        ...
						        var _this35 = _possibleConstructorReturn(this, _TestRunErrorBase20.call(this, _type2.default.actionSelectorMatchesWrongNodeTypeError));

						        _this35.nodeDescription = nodeDescription;
						        return _this35;
						    }
						...
						var ActionAdditionalElementNotFoundError = exports.ActionAdditionalElementNotFoundError = function (_TestRunErrorBase21) {
						    ...
						    function ActionAdditionalElementNotFoundError(argumentName) {
						        ...
						        var _this36 = _possibleConstructorReturn(this, _TestRunErrorBase21.call(this, _type2.default.actionAdditionalElementNotFoundError));
						...
						var ActionAdditionalElementIsInvisibleError = exports.ActionAdditionalElementIsInvisibleError = function (_TestRunErrorBase22) {
						    ...
						    function ActionAdditionalElementIsInvisibleError(argumentName) {
						        ...
						        var _this37 = _possibleConstructorReturn(this, _TestRunErrorBase22.call(this, _type2.default.actionAdditionalElementIsInvisibleError));
						...
						var ActionAdditionalSelectorMatchesWrongNodeTypeError = exports.ActionAdditionalSelectorMatchesWrongNodeTypeError = function (_TestRunErrorBase23) {
						    ...
						    function ActionAdditionalSelectorMatchesWrongNodeTypeError(argumentName, nodeDescription) {
						        ...
						        var _this38 = _possibleConstructorReturn(this, _TestRunErrorBase23.call(this, _type2.default.actionAdditionalSelectorMatchesWrongNodeTypeError));

						        _this38.argumentName = argumentName;
						        _this38.nodeDescription = nodeDescription;
						        return _this38;
						    }
						...
						var ActionElementNonContentEditableError = exports.ActionElementNonContentEditableError = function (_TestRunErrorBase26) {
						    ...
						    function ActionElementNonContentEditableError(argumentName) {
						        ...
						        var _this41 = _possibleConstructorReturn(this, _TestRunErrorBase26.call(this, _type2.default.actionElementNonContentEditableError));
						...
						var ActionIncorrectKeysError = exports.ActionIncorrectKeysError = function (_TestRunErrorBase28) {
						    ...
						    function ActionIncorrectKeysError(argumentName) {
						        ...
						        var _this43 = _possibleConstructorReturn(this, _TestRunErrorBase28.call(this, _type2.default.actionIncorrectKeysError));
						...
						var ActionCanNotFindFileToUploadError = exports.ActionCanNotFindFileToUploadError = function (_TestRunErrorBase29) {
						    ...
						    function ActionCanNotFindFileToUploadError(filePaths) {
						        ...
						        var _this44 = _possibleConstructorReturn(this, _TestRunErrorBase29.call(this, _type2.default.actionCanNotFindFileToUploadError));

						        _this44.filePaths = filePaths;
						        return _this44;
						    }
						...
						var ActionInvalidScrollTargetError = exports.ActionInvalidScrollTargetError = function (_TestRunErrorBase31) {
						    ...
						    function ActionInvalidScrollTargetError(scrollTargetXValid, scrollTargetYValid) {
						        ...
						        var _this46 = _possibleConstructorReturn(this, _TestRunErrorBase31.call(this, _type2.default.actionInvalidScrollTargetError));

						        if (!scrollTargetXValid) {
						            if (!scrollTargetYValid) _this46.properties = 'scrollTargetX and scrollTargetY properties';else _this46.properties = 'scrollTargetX property';
						        } else _this46.properties = 'scrollTargetY property';
						        return _this46;
						    }
						...
						var WindowDimensionsOverflowError = exports.WindowDimensionsOverflowError = function (_TestRunErrorBase32) {
						    ...
						    function WindowDimensionsOverflowError(callsite) {
						        ...
						        var _this47 = _possibleConstructorReturn(this, _TestRunErrorBase32.call(this, _type2.default.windowDimensionsOverflowError));
						...
						var InvalidElementScreenshotDimensionsError = exports.InvalidElementScreenshotDimensionsError = function (_TestRunErrorBase33) {
						    ...
						    function InvalidElementScreenshotDimensionsError(width, height) {
						        ...
						        var _this48 = _possibleConstructorReturn(this, _TestRunErrorBase33.call(this, _type2.default.invalidElementScreenshotDimensionsError));
						        ...
						        if (widthIsInvalid) {
						            if (heightIsInvalid) {
						                _this48.verb = 'are';
						                _this48.dimensions = 'width and height';
						            } else {
						                _this48.verb = 'is';
						                _this48.dimensions = 'width';
						            }
						        } else {
						            _this48.verb = 'is';
						            _this48.dimensions = 'height';
						        }
						        return _this48;
						    }
						...
						var RoleSwitchInRoleInitializerError = exports.RoleSwitchInRoleInitializerError = function (_TestRunErrorBase34) {
						    ...
						    function RoleSwitchInRoleInitializerError(callsite) {
						        ...
						        var _this49 = _possibleConstructorReturn(this, _TestRunErrorBase34.call(this, _type2.default.roleSwitchInRoleInitializerError));

						        _this49.callsite = callsite;
						        return _this49;
						    }
						...
						var NativeDialogNotHandledError = exports.NativeDialogNotHandledError = function (_TestRunErrorBase40) {
						    ...
						    function NativeDialogNotHandledError(dialogType, url) {
						        ...
						        var _this55 = _possibleConstructorReturn(this, _TestRunErrorBase40.call(this, _type2.default.nativeDialogNotHandledError));
						...
						var UncaughtErrorInNativeDialogHandler = exports.UncaughtErrorInNativeDialogHandler = function (_TestRunErrorBase41) {
						    ...
						    function UncaughtErrorInNativeDialogHandler(dialogType, errMsg, url) {
						        ...
						        var _this56 = _possibleConstructorReturn(this, _TestRunErrorBase41.call(this, _type2.default.uncaughtErrorInNativeDialogHandler));

						        _this56.dialogType = dialogType;
						        _this56.errMsg = errMsg;
						        _this56.pageUrl = url;
						        return _this56;
						    }
						...
						var SetNativeDialogHandlerCodeWrongTypeError = exports.SetNativeDialogHandlerCodeWrongTypeError = function (_TestRunErrorBase42) {
						    ...
						    function SetNativeDialogHandlerCodeWrongTypeError(actualType) {
						        ...
						        var _this57 = _possibleConstructorReturn(this, _TestRunErrorBase42.call(this, _type2.default.setNativeDialogHandlerCodeWrongTypeError));

						        _this57.actualType = actualType;
						        return _this57;
						    }
				...
				"commands": {
					...
					"utils.js": function (exports, module, require) {
						...
						function isJSExpression(val) {
						    return val !== null && (typeof val === 'undefined' ? 'undefined' : _typeof(val)) === 'object' && val.type === RAW_API_JS_EXPRESSION_TYPE && typeof val.value === 'string';
						}
					},
					"validations": {
...
})("testcafe-phoenix/src/client/driver/index");
