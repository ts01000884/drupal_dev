						...
						"scroll.js": function (exports, module, require) {
							...
							var ScrollAutomation = function () {
							    ...
							    ScrollAutomation.prototype._getScrollToPoint = function _getScrollToPoint(elementDimensions, _ref2) {
							        ...
							        var leftScrollMargin = this.scrollToCenter ? horizontalCenter : Math.min(this.maxScrollMargin.left, horizontalCenter);
							        var topScrollMargin = this.scrollToCenter ? verticalCenter : Math.min(this.maxScrollMargin.top, verticalCenter);
							    ...
							    ScrollAutomation.prototype._getScrollToFullChildView = function _getScrollToFullChildView(parentDimensions, childDimensions) {
							        ...
							        if (canShowFullElementWidth) {
							            ...
							            var leftScrollMargin = Math.min(this.maxScrollMargin.left, availableLeftScrollMargin);
							        ...
							        if (canShowFullElementHeight) {
							            ...
							            var topScrollMargin = Math.min(this.maxScrollMargin.top, availableTopScrollMargin);
							    ...
							    ScrollAutomation.prototype._getScrollPosition = function _getScrollPosition(parentDimensions, childDimensions, offsetX, offsetY) {
							        var childPoint = {
							    ...
							    ScrollAutomation.prototype._getChildPointAfterScroll = function _getChildPointAfterScroll(parentDimensions, childDimensions, left, top) {
							        var x = Math.round(childDimensions.left + parentDimensions.scroll.left - left + childDimensions.width / 2);
							        var y = Math.round(childDimensions.top + parentDimensions.scroll.top - top + childDimensions.height / 2);
							    ...
							    ScrollAutomation.prototype._scrollToChild = function _scrollToChild(parent, child, _ref3) {
							        ...
							        while (needScroll) {
							            ...
							            var _getChildPointAfterSc = this._getChildPointAfterScroll(parentDimensions, childDimensions, scrollPos.left, scrollPos.top),
							                x = _getChildPointAfterSc.x,
							                y = _getChildPointAfterSc.y;
