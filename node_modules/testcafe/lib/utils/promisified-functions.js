...
const ensureDir = exports.ensureDir = (0, _promisify2.default)(_mkdirp2.default);
...
const findProcess = exports.findProcess = (0, _promisify2.default)(_psNode2.default.lookup);
const killProcess = exports.killProcess = (0, _promisify2.default)(_psNode2.default.kill);
